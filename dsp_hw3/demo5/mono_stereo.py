...
#choose the file
wavefile = input("Type the name of the wave file: ")

#play the file typed in
...
if (num_channels==1): #The file is a mono file
...
if (num_channels==2): #The file is a stereo file
    while len(input_bytes) > 0:
        ...
        output_value0 = int(clip16(gain * input_tuple[0])) # Integer in allowed range
        output_value1 = int(clip16(gain * input_tuple[1])) # Integer in allowed range
